...
<template>
    <div class="w-full bg-snow text-coal fixed top-0 left-0 z-10">
        <div class="px-[24px] py-[18px] flex justify-between items-center">
            <div class="w-[50px] flex" :style="{ height: (opened && !isMobile) ? '28px' : '14px' }">
            ...
            <div class="w-[50px] flex gap-[12px] items-center justify-end">
        ...
        <div v-show="opened" class="px-[24px] pt-[30px] pb-[48px]">
            <div class="flex justify-between">
                ...
                <PrismicImage v-show="!isMobile" :field="menu.data.image" :style="{ height: linksListHeight + 'px' }" />
            </div>
