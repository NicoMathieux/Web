...
watch(isHovered, (isHoveredNow, wasHoveredBefore) => {
	if (props.slice.variation !== "withSubmenu") return;
...
<template>
  ...
  >
	...
	<div v-show="slice.variation === 'withSubmenu' && showSubmenu" class="absolute top-0 left-[100%] ml-[15px] gap-[15px] flex items-start bg-snow">
		<img class="w-[24px] mt-[20px]" :class="`submenu-link-${index}`" src="/assets/images/arrow-coal.png" />
